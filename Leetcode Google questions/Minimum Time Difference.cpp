//optimization - corner case of the time difference being over midnight
//i.e. 00:00 and 23:59 will happen only with the biggest time
//and smallest time in same day format
//so no need to add (24*60) to all-
...
public:
    int findMinDifference(vector<string>& timePoints) {
        ...
        closestTime = min(closestTime, (mins[0] + (24*60)) - mins[mins.size()-1]);
